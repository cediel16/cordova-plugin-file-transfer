...
### 1.7.2 (Aug 08, 2023)
* (https://github.com/apache/cordova-plugin-file-transfer/issues/258) remove UserAgent for iOS 
* (https://github.com/apache/cordova-plugin-file-transfer/issues/345) remove Whitelist for Android
